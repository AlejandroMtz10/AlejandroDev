...
function Navbar() {
    ...
    return (
        <div className="w-full bg-[#1a1a1a] text-white shadow-md py-2">
            <div className="container mx-auto flex justify-between items-center py-4 px-4 sm:px-6">
                {/* Logo */}
                <div className="flex items-center">
                    <img src={smallLogo} alt="Alejandro Developer" className="w-32 h-auto" />
                </div>

                {/* Botón Hamburguesa */}
                <div className="sm:hidden">
                    <button onClick={toggleMenu} id="btn_menu" name="btn_menu" className="text-3xl">
                        <GiHamburgerMenu />
                    </button>
                </div>
